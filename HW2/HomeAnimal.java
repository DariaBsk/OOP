...
public abstract class HomeAnimal extends Animal implements Home{
    ...
    public String toString(){
        return String.format("Имя: %s; Порода: %s;Наличие прививок: %s; Цвет шерсти: %s; Дата рождения: %s; %s;", this.name, this.breed, this.vaccination, this.color, this.dateBirthday, super.toString());
    }

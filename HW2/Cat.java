...
public class Cat extends HomeAnimal{
    ...
    protected Cat(String name, String breed, String vaccination, String color, String dateBirthday, int height, int weight, String colorEye, String wool) {
    ...
    public void caressing() {
        System.out.println("Кошка хочет вашей ласки!");
    }
